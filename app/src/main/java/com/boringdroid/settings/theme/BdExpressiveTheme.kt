package com.boringdroid.settings.theme
...
// Token values mirror the design bundle's tokens.css (seed #6750A4). Kept in sync with the
// BoringdroidSystemUI copy so Settings and SystemUI share the same Expressive palette.
